...
alter table respostas_escala add constraint respostas_escala_escala_check
  check (escala in ('cssrs', 'phq9', 'phq2', 'gad7', 'snap-iv', 'srq20', 'gds15', 'epds', 'dass21', 'pss10'));
...
begin
  ...
  if p_escala not in ('cssrs', 'phq9', 'phq2', 'gad7', 'snap-iv', 'srq20', 'gds15', 'epds', 'dass21', 'pss10') then
